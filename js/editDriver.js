(function() {
    ...
    document.querySelector("#buttonedit").addEventListener("click", event => {
        ...
        let value6 = document.querySelector("#driver_id").value;
        let value7 = document.querySelector("#driveremail").value;
        ...
        firebase.database().ref(`driver/${value6}/`).update({
            car_id: value1,
            driver_id: key,
        ...
        document.querySelector("#driver_id").value = "";
